...
<div
            ...
            <div>
                <h2 class="text-3xl font-extrabold">Entra in Contatto</h2>
                <p class="text-sm text-gray-400 mt-3">E' interessato/a a una richiesta specifica o desidera esplorare nuove opportunità? Il nostro team esperto è pronto a interagire con lei.</p>
                <form>
                ...
                <ul class="mt-4 flex justify-center lg:space-x-6 max-lg:flex-col max-lg:items-center max-lg:space-y-2 ">
                    <li class="flex items-center hover:text-blue-500">
                        ...
                        <a href="mailto:{{$companyEmail}}" class="text-current text-sm ml-3">
                            <strong>{{$companyEmail}}{{--carossa.immobiliare@libero.it--}}</strong>
                        </a>
                    </li>
                    <li class="flex items-center text-current hover:text-blue-500">
                        ...
                        <a href="tel:{{$companyPhone}}" class="text-current text-sm ml-3">
                            <strong>{{$companyPhone}}</strong>
                        </a>
                    </li>
                </ul>
            </div>
            {{--ca rossa immobiliare, via ca rossa 91 venezia--}}
            <div class="z-10 relative h-full max-md:min-h-[350px]">
                <iframe src="https://maps.google.com/maps?q={{$mapsQuery}}&t=&z=13&ie=UTF8&iwloc=&output=embed"
