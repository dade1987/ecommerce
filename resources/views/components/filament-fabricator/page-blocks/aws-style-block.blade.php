...
<section class="relative bg-gradient-to-br from-slate-50 via-white to-blue-50 py-8 lg:py-14 overflow-hidden">
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <!-- Sezione "Perché AWS?" -->
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:items-stretch lg:gap-14 mb-20">
                    ...
                    <div class="relative group">
                        ...
                        <button type="button"
                           ...
                           class="cta-shine relative w-full flex items-center justify-center gap-3 px-8 py-5 text-lg font-bold text-white bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-700 rounded-xl shadow-2xl shadow-blue-600/30 hover:shadow-blue-600/50 transform hover:scale-105 transition-all duration-300 group-hover:from-blue-700 group-hover:via-blue-800 group-hover:to-indigo-800 cursor-pointer">
                            ...
                            <span>Prenota una call tecnica di 15 minuti</span>
            ...
            <!-- Colonna destra: Portfolio Preview -->
            <div class="relative order-2 flex flex-col" x-data="{ activeProject: null }">
                <!-- Portfolio Container - solido, secondario per gerarchia non per opacity -->
                <div class="relative bg-white rounded-xl border border-gray-200 shadow-sm flex flex-col flex-1">
                    
                    <!-- Header Portfolio -->
                    <div class="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
                        <p class="text-xs font-semibold text-gray-600 uppercase tracking-wide">Portfolio</p>
                        <span class="text-[10px] text-gray-500 font-medium">{{ __('frontend.real_projects') }}</span>
                    </div>
                    
                    <!-- Lista Progetti (max 5, preview) -->
                    <div class="p-3 space-y-1 flex-1">
                        <!-- Descrizione contesto -->
                        <p class="text-xs text-gray-500 mb-3 px-1">Esempi reali di gestionali Laravel utilizzati ogni giorno, non demo.</p>
                        ...
                        @foreach(array_slice($accordionItems ?? [], 0, 5) as $index => $item)
                            <div 
                                ...
                                :class="{ 
                                    ...
                                    'hover:bg-gray-50': activeProject !== {{ $index }}
                                }"
                            >
                                <button 
                                    @click="activeProject = activeProject === {{ $index }} ? null : {{ $index }}"
                                    class="w-full px-3 py-2.5 text-left flex items-center justify-between"
                                >
                                    <div class="flex items-center space-x-2.5">
                                        @if(isset($item['icon']))
                                            <div class="flex-shrink-0 w-7 h-7 rounded-md bg-gray-100 flex items-center justify-center">
                                ...
                                >
                                    <div class="px-3 pb-3">
                                        <div class="pl-10 text-sm text-gray-600 leading-relaxed">
                                            {!! $item['content'] !!}
                                        </div>
                                    </div>
                                </div>
                    ...
                    <!-- Link Portfolio - secondario ma visibile -->
                    <div class="px-4 py-3 border-t border-gray-100 mt-auto">
                        <a href="/portfolio" class="group flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors duration-200">
