    ...
    <div class="relative wrap overflow-hidden p-10 h-full">
        ...
        <div class="mb-8 flex justify-between items-center w-full right-timeline">
            ...
            <div class="order-1 bg-gray-400 rounded-lg shadow-xl w-5/12 px-6 py-4">
                <h3 class="mb-3 font-bold text-gray-800 text-xl">{{ $text }}</h3>
                <p class="text-sm leading-snug tracking-wide text-gray-900 text-opacity-100">{{ $textTwo }}</p>
            </div>
        </div>
        ...
        <div class="mb-8 flex justify-between items-center w-full right-timeline">
            ...
            <div class="order-1 bg-gray-400 rounded-lg shadow-xl w-5/12 px-6 py-4">
                <h3 class="mb-3 font-bold text-gray-800 text-xl">{{ $textFive }}</h3>
                <p class="text-sm leading-snug tracking-wide text-gray-900 text-opacity-100">{{ $textSix }}</p>
            </div>
        </div>
