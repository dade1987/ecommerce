<!-- Container principale: header, quick replies e messaggi -->
<div id="chatContainer" class="flex flex-col h-screen w-screen bg-[#343541] p-4 pb-32">
  <!-- Header / Titolo -->
  ...
  <!-- pb-32 per evitare che l'ultimo messaggio venga coperto dal footer fisso -->
...
<!-- Footer fisso con input e pulsante di invio -->
