<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16" wire:key="domain-analyzer-{{ now() }}">
    <div class="p-4 border rounded-lg shadow-sm bg-white dark:bg-gray-800">
        ...
        <div wire:loading.flex wire:target="analyze" wire:poll.1s="updateStatus" class="items-center justify-center p-8 mt-6 text-center">
