    ...
    <div class="p-4 border rounded-lg shadow-sm bg-white dark:bg-gray-800">
        ...
        <div wire:loading.flex wire:target="analyze" class="items-center justify-center p-8 mt-6 text-center">
            <div class="text-lg font-semibold">
                ...
                <span class="ml-4">Analisi in corso... Questo potrebbe richiedere fino a 30 secondi.</span>
            </div>
        </div>
        ...
        @if ($result && !$error)
            <div class="p-6 mt-6 border rounded-lg">
                <h3 class="text-xl font-bold text-center text-gray-800 dark:text-gray-100">Risultato Analisi per: {{ $domain }}</h3>

                <div class="my-6 text-center">
                    <p class="text-lg text-gray-600 dark:text-gray-300">Rischio di Compromissione (prossimi 3 mesi)</p>
                ...
                @if ($result['risk_percentage'] > 30)
                    <div class="p-4 my-6 text-center text-yellow-800 bg-yellow-100 border-l-4 border-yellow-500 rounded-md">
                        <p class="font-bold">Il tuo livello di rischio è elevato!</p>
                        <p class="text-sm">È molto meglio per te prenotare una call con noi per mitigare i rischi il prima possibile.</p>
                        @livewire('open-calendar-button')
                    </div>
                @endif

                <div class="mt-6">
                    <h4 class="text-lg font-semibold text-gray-700 dark:text-gray-200">Punti Critici Rilevati:</h4>
                    <ul class="mt-2 space-y-2 list-disc list-inside">
                        ...
                        @empty
                            <li class="text-gray-500">Nessun punto critico specifico evidenziato. Ottimo lavoro!</li>
                        @endforelse
                    </ul>
                </div>
