                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="mt-1 space-y-1 text-sm text-slate-500">
                            <p class="flex items-start">
                                <span class="font-semibold inline-block w-16 shrink-0">Tel:</span>
                                <span class="truncate">{{ $row->phone_number ?? '-' }}</span>
                            </p>
                            <p class="flex items-start">
                                <span class="font-semibold inline-block w-16 shrink-0">Email:</span>
                                <span class="truncate">{{ $row->email ?? '-' }}</span>
                            </p>
                            <p class="flex items-start">
                                <span class="font-semibold inline-block w-16 shrink-0">Web:</span>
                                <span class="truncate">
                                @if($row->website)
                            ...
                            <p class="flex items-start">
                                <span class="font-semibold inline-block w-16 shrink-0">Prezzo:</span>
