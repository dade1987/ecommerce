        ...
        @if ($product)
            ...
            <div
                ...
                @foreach ($product->variations as $variation)
                    ...
                    <button
                        wire:click="$dispatch('add-food-to-cart', { product_id: '{{ $variation->id }}', parent_product_id: '{{ $product->id }}', option: '+' })"
                        type="button"
                    ...
                    <button
                        wire:click="$dispatch('add-food-to-cart', { product_id: '{{ $variation->id }}', parent_product_id: '{{ $product->id }}', option: 'No' })"
                        type="button"
