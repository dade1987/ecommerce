...
if ($status == AUTH_LOGGED && license_has($user, "sede_centrale")) {
    if (isset($_POST['memorizza'])) {
        $sql = "INSERT INTO db_fatture (fattura,negozio,data,intestatario,totale_fattura)
            VALUES ('" . addslashes($_POST['html']) . "','" . $user['nome_negozio'] . "','" . date('Y-m-d H:i:s', strtotime('now')) . "','" . $_POST['intestatario'] . "','-" . $_POST['totale_totale'] . "')";
            ...
            <form method="POST">
                ...
                <div id="area_stampa">
                    <div style="background-color:white;width:100%;clear:both;  min-height:75px;padding:10px;">
                        <h2>NOTA DI CREDITO NUMERO: <?php echo $numero_fattura; ?> DEL <?php echo date("d-m-Y"); ?></h2>
                    </div>
                    <br/>
                    ...
                    <div style="background-color:white;width:45%;float:right;min-height:200px;margin-bottom:20px;padding:10px;">
                        ...
                        <p><?php echo "<input type='text' placeholder='Indirizzo' style='width:100%;' value='" . $intestatario['indirizzo_sede_legale'] . "'></input><br/>"
                                . "<br/><input type='text' placeholder='Città (PR)' style='width:100%;'";
                        if(!empty($intestatario['citta_sede_legale']))
                            echo "value='" . $intestatario['citta_sede_legale'] . " " . $intestatario['provincia_sede_legale'] . "'";
                        echo "></input>"; ?></input></p>
                        <p><?php echo "<input type='text' placeholder='P.I. - C.F.' style='width:100%;' ";
                    ...
                    <div style="background-color:white;width:100%;clear:both; margin-bottom:20px; overflow:auto;padding:10px;">
                        ...
                        <div style="width:24%;float:left;"><b>Quantità</b><br/><textarea id="quantita" style="min-height:170px;"></textarea></div>
