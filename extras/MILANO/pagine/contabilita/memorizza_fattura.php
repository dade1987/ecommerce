...
$sql="INSERT INTO db_fatture (anno,numero_fattura,totale_fattura,fattura,negozio,intestatario,data)
VALUES ('".date('Y')."','".numero_fattura()."','".$_SESSION['totale_fattura']."','".addslashes($_SESSION['tabella_fattura'])."','".$user['nome_negozio']."','".$_SESSION['dati_fattura']['intestatario']."','".date('Y-m-d H:i:s',strtotime('now'))."')";
