...
<html>
    <head>
        <title>Welcome to <? print $host; ?>! Hostinger - Hosting gratuito con PHP e MySQL.</title>
    ...
    <body>
        <div id="main">
            <div id="content">
                <div class="header">
                    <a id="logo" href="http://www.hostinger.it/"><img src="http://www.hostinger.it/images/logo-it.png" alt="Hosting" /></a>
                </div>
                <div class="content">
                    <h1>Il tuo account è stato creato!</h1>
                    <p>Il sito web <b><? print $host; ?></b> &egrave; stato installato con successo sul server! Per favore elimina il file <b>default.php</b> dalla cartella <b>public_html</b> e poi carica il tuo sito web con un client FTP o con il Gestore File.</p>
                    <p>Ecco una lista dei file che sono sul tuo spazio:</p>
                    <div id="files">
                        <div class="top"></div>
                        <div class="cont">
            ...
            <div id="footer">
                <div class="links">
                    <a href="http://www.hostinger.it/hosting-gratuito" target="_blank">Hosting Gratuito</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.it/web-hosting" target="_blank">Hosting Web</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.it/forum" target="_blank">Forum di Supporto</a> 
                    <span class="pipe">|</span> 
                    <a href="http://cpanel.hostinger.it/" target="_blank">Area Clienti</a>
                </div>
                <div class="copyright">Hostinger Italia &copy; <? print date('Y'); ?>. Tutti i diritti riservati.</div>
                <div class="social-icons">
                    <a href="http://www.facebook.com/Hostinger.it"><img src="http://www.main-hosting.com/hostinger/welcome/images/fb.gif" /></a>
