    ...
    public function handleChat(Request $request)
    {
        ...
        $run = $this->client->threads()->runs()->create(
            ...
            parameters: [
                ...
                'instructions' => 'Se chiedo quali servizi, trattamenti o attività offri, esegui la function call getProductInfo. Se richiedo informazioni sul luogo o numero di telefono dell\'azienda, esegui la function call getAddressInfo. Se chiedo gli orari disponibili, esegui la function call getAvailableTimes. Se desidero prenotare un trattamento o un servizio, esegui la function call createOrder. Se insrisco da qualche parte i dati dell\'utente, esegui la function call submitUserData. Se richiedo le domande frequenti, esegui la function call getFAQs. Per domande non inerenti al contesto, utilizza la funzione fallback. In ogni caso, chiedi prima il nome dell\'utente, poi l\'email in un secondo messaggio, e infine il numero di telefono all\'atto della prenotazione dell\'ordine dicendo che è solo ai fini della demo.',
                'model'        => 'gpt-4o',
                'tools'        => [
                    [
                        'type'     => 'function',
