...
class QuoterController extends Controller
{
    ...
    private function generateContentBasedOnMessage($userMessage)
    {
        ...
        if ($userMessage === 'Intro') {
            ...
            Alla fine crea un preventivo basato sul prezzo medio al metro quadro di un pannello fotovoltaico, per coprire i kw che servono. Conta che per fare 5kw servono 30mq';
